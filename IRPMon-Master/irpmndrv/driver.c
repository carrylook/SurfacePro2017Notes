...
static NTSTATUS _HandleCDORequest(ULONG ControlCode, PVOID InputBuffer, ULONG InputBufferLength, PVOID OutputBuffer, ULONG OutputBufferLength, PIO_STATUS_BLOCK IoStatus)
{
	...
	switch (ControlCode) {
		case IOCTL_IRPMNDRV_CONNECT:
			...
			//DbgPrintEx(DPFLTR_DEFAULT_ID, DPFLTR_ERROR_LEVEL,"\n_HandleCDORequest:IOCTL_IRPMNDRV_CONNECT");
			break;
		case IOCTL_IRPMNDRV_DISCONNECT:
			UMRequestQueueDisconnect();
			status = STATUS_SUCCESS;
			//DbgPrintEx(DPFLTR_DEFAULT_ID, DPFLTR_ERROR_LEVEL, "\n_HandleCDORequest:IOCTL_IRPMNDRV_DISCONNECT");
			break;
		case IOCTL_IRPMNDRV_GET_RECORD:
			...
			//DbgPrintEx(DPFLTR_DEFAULT_ID, DPFLTR_ERROR_LEVEL, "\n_HandleCDORequest:IOCTL_IRPMNDRV_GET_RECORD");
			break;
		...
		case IOCTL_IRPMNDRV_HOOK_ADD_DEVICE:
			...
			if (NT_SUCCESS(status))
				IoStatus->Information = OutputBufferLength;
			//DbgPrintEx(DPFLTR_DEFAULT_ID, DPFLTR_ERROR_LEVEL, "\n_HandleCDORequest:IOCTL_IRPMNDRV_HOOK_ADD_DEVICE");
			break;
		...
		case IOCTL_IRPMNDRV_HOOK_DRIVER_SET_INFO:
			...
			//DbgPrintEx(DPFLTR_DEFAULT_ID, DPFLTR_ERROR_LEVEL, "\n_HandleCDORequest:IOCTL_IRPMNDRV_HOOK_DRIVER_SET_INFO");
			break;
		case IOCTL_IRPMNDRV_HOOK_DRIVER_GET_INFO:
			...
			//DbgPrintEx(DPFLTR_DEFAULT_ID, DPFLTR_ERROR_LEVEL, "\n_HandleCDORequest:IOCTL_IRPMNDRV_HOOK_DRIVER_GET_INFO");
			break;
		case IOCTL_IRPMNDRV_HOOK_DEVICE_SET_INFO:
			...
			//DbgPrintEx(DPFLTR_DEFAULT_ID, DPFLTR_ERROR_LEVEL, "\n_HandleCDORequest:IOCTL_IRPMNDRV_HOOK_DEVICE_SET_INFO");
			break;
		case IOCTL_IRPMNDRV_HOOK_DEVICE_GET_INFO:
			...
			//DbgPrintEx(DPFLTR_DEFAULT_ID, DPFLTR_ERROR_LEVEL, "\n_HandleCDORequest:IOCTL_IRPMNDRV_HOOK_DEVICE_GET_INFO");
			break;
		case IOCTL_IRPMNDRV_HOOK_DRIVER_MONITORING_CHANGE:
			...
			//DbgPrintEx(DPFLTR_DEFAULT_ID, DPFLTR_ERROR_LEVEL, "\n_HandleCDORequest:IOCTL_IRPMNDRV_HOOK_DRIVER_MONITORING_CHANGE");
			break;
		case IOCTL_IRPMONDRV_HOOK_GET_INFO:
			...
			if (NT_SUCCESS(status))
				IoStatus->Information = OutputBufferLength;
			//DbgPrintEx(DPFLTR_DEFAULT_ID, DPFLTR_ERROR_LEVEL, "\n_HandleCDORequest:IOCTL_IRPMONDRV_HOOK_GET_INFO");
			break;
		...
		case IOCTL_IRPMNDRV_CLASS_WATCH_REGISTER:
			...
			//DbgPrintEx(DPFLTR_DEFAULT_ID, DPFLTR_ERROR_LEVEL, "\n_HandleCDORequest:IOCTL_IRPMNDRV_CLASS_WATCH_REGISTER");
			break;
		case IOCTL_IRPMNDRV_CLASS_WATCH_UNREGISTER:
			...
			//DbgPrintEx(DPFLTR_DEFAULT_ID, DPFLTR_ERROR_LEVEL, "\n_HandleCDORequest:IOCTL_IRPMNDRV_CLASS_WATCH_UNREGISTER");
			break;
		case IOCTL_IRPMNDRV_CLASS_WATCH_ENUM:
			...
			//DbgPrintEx(DPFLTR_DEFAULT_ID, DPFLTR_ERROR_LEVEL, "\n_HandleCDORequest:IOCTL_IRPMNDRV_CLASS_WATCH_ENUM");
			break;
		case IOCTL_IRPMNDRV_DRIVER_WATCH_REGISTER:
			...
			//DbgPrintEx(DPFLTR_DEFAULT_ID, DPFLTR_ERROR_LEVEL, "\n_HandleCDORequest:IOCTL_IRPMNDRV_DRIVER_WATCH_REGISTER");
			break;
		case IOCTL_IRPMNDRV_DRIVER_WATCH_UNREGISTER:
			...
			//DbgPrintEx(DPFLTR_DEFAULT_ID, DPFLTR_ERROR_LEVEL, "\n_HandleCDORequest:IOCTL_IRPMNDRV_DRIVER_WATCH_UNREGISTER");
			break;
		case IOCTL_IRPMNDRV_DRIVER_WATCH_ENUM:
			...
			//DbgPrintEx(DPFLTR_DEFAULT_ID, DPFLTR_ERROR_LEVEL, "\n_HandleCDORequest:IOCTL_IRPMNDRV_DRIVER_WATCH_ENUM");
			break;
		default:
